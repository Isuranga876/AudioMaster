...
var o = { fetchBlob: function(e, i, n) {
	return t(this, void 0, void 0, (function* () {
...
var y = class extends e {
	...
	initEvents() {
		this.wrapper.addEventListener("click", ((t) => {
			const [i, n] = p(this.wrapper.getBoundingClientRect(), t.clientX, t.clientY);
			this.emit("click", i, n);
	...
	initDrag() {
		...
		this.dragStream = function(t, e = {}) {
			const { threshold: i = 3, mouseButton: n = 0, touchDelay: s = 100 } = e, r = a(null), o = /* @__PURE__ */ new Map(), l = matchMedia("(pointer: coarse)").matches;
			let h = () => {};
			const c = (e) => {
				if (e.button !== n) return;
				if (o.set(e.pointerId, e), o.size > 1) return;
				let a = e.clientX, c = e.clientY, u = !1;
				const d = Date.now(), { left: m, top: g } = t.getBoundingClientRect(), v = (t) => {
				...
				document.addEventListener("pointermove", v), document.addEventListener("pointerup", f), document.addEventListener("pointerout", b), document.addEventListener("pointercancel", b), document.addEventListener("touchmove", C, { passive: !1 }), document.addEventListener("click", y, { capture: !0 }), h = () => {
...
var P = class P extends c {
		...
		const { state: i, actions: n } = function(t) {
			...
			return {
				state: {
					...
					scrollPosition: y,
					canPlay: S,
					isReady: l((() => S.value && c.value > 0), [S, c]),
					progress: l((() => h.value), [h]),
					progressPercent: l((() => c.value > 0 ? h.value / c.value : 0), [h, c])
				},
				actions: {
					setCurrentTime: (t) => {
						const e = Math.max(0, Math.min(c.value || Infinity, t));
						h.set(e);
					},
					setDuration: (t) => {
						c.set(Math.max(0, t));
	...
	getDuration() {
		...
		return 0 !== t && t !== Infinity || !this.decodedData || (t = this.decodedData.duration), t;
	}
	toggleInteraction(t) {
